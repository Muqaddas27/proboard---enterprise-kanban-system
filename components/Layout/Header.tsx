    ...
    <nav className="px-6 py-4 border-b border-white/10 backdrop-blur-xl fixed top-0 left-0 right-0 z-[100] bg-slate-900/95">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <button onClick={onNavigateLanding} className="flex items-center gap-3 hover:opacity-80 transition group">
          <div className="w-10 h-10 bg-gradient-to-br from-indigo-500 via-indigo-600 to-purple-600 rounded-xl flex items-center justify-center shadow-lg shadow-indigo-500/50 group-hover:scale-110 transition-transform">
        ...
        {/* CTA Button */}
        <button onClick={onNavigateLogin} className="px-6 py-2.5 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 rounded-xl font-bold text-sm transition-all shadow-lg shadow-indigo-500/50 active:scale-95">
          Get Started
        </button>
      </div>
    </nav>
